...
namespace JOYSTICK
{
  ...
  {
  public:
    CKeymapHandler(IActionHandler *handler, const IKeymap *keymap);
    ...
    virtual bool HasAction(const FeatureName& feature) const override;
  ...
  private:
    ...
    IActionHandler *const m_handler;
